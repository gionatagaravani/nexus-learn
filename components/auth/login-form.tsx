...
export function LoginForm() {
  ...
  const handleSubmit = async (e: React.SyntheticEvent) => {
    ...
    // Refresh the auth context and then navigate
    await refreshUser()
    router.push('/')
    router.refresh()
  }
    ...
    <div className="w-full max-w-sm">
      ...
      <div className="mt-6">
        ...
        <button
          ...
          disabled={loading}
          className="mt-4 w-full py-2.5 bg-white border border-black/[0.08] rounded-xl text-sm font-medium hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-black/[0.08] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
